...
public class tcpResponseTests {
	...
	public void testDelete() {
		DataParser parser = new DataParser();
		int output1 = parser.receiveDelete("DELETED 1 1 1 3 3 3")[0][0];
		int output2 = parser.receiveDelete("DELETED 1 1 1 3 3 3")[1][0];
		int output3 = parser.receiveDelete("DELETED 1 1 1 3 3 3")[2][0];
		
		assertEquals(95,output1);
		assertEquals(225,output2);
